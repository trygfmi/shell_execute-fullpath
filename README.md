...
<p>このリポジトリは、シェルのコマンドをフルパスで実行して普段通りに実行結果を出力できるのか確認します</p>
</div>
...
<div class="wp-block-group">
<p>以下のコマンドを実行して出力結果を確認してみてください</p>
...
<pre class="wp-block-code has-background" style="background-color:#ffeeee"><code>print your hostname

print your hostname</code></pre>
</details>
</div>
...
<pre class="wp-block-code has-24292-eff-color has-text-color has-background has-1-125-rem-font-size" style="background-color:#ffeeee"><code>print your hostname
...
<div class="wp-block-group">
<p>whichコマンドで実行するコマンドのフルパスを取得できます<br>パスを省略して実行できるのは環境変数の$PATHにパスを登録しているからです<br>以下のコマンドで登録されているパスを確認することができます</p>
